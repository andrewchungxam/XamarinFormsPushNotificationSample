...
namespace AndroidAzureConstants
{
    ...
    {
        public const string NativeApiURL =                  "https://xfnotificationfunctions4.azurewebsites.net/" + "api/NotificationFunctionNative";
        public const string TemplateApiURL =                "https://xfnotificationfunctions4.azurewebsites.net/" + "api/NotificationFunctionTemplate";
        public const string MultipleTemplateApiURL =        "https://xfnotificationfunctions4.azurewebsites.net/" + "api/NotificationFunctionTemplateMultiple";

        public const string AndroidNativeApiURL =           "https://xfnotificationfunctions4.azurewebsites.net/" + "api/AndroidNotificationFunctionNative";
        public const string AndroidTemplateApiURL =         "https://xfnotificationfunctions4.azurewebsites.net/" + "api/AndroidNotificationFunctionTemplate";
        public const string AndroidMultipleTemplateApiURL = "https://xfnotificationfunctions4.azurewebsites.net/" + "api/AndroidNotificationFunctionTemplateMultiple";
    }
}
